...
import { Card, CardContent, CardCover, Typography, Stack, AccordionGroup, Accordion, AccordionDetails, AccordionSummary, Button } from "@mui/joy";
import { Train, DirectionsCar, MergeType, TrendingUp, Coronavirus } from '@mui/icons-material';
...
const Home: React.FC<HomeProps> = ({ currentSection, setSection }) => {
  const [currentKeyFinding, setCurrentKeyFinding] = useState<KeyFinding>(KeyFinding.None);
