    ...
    <Stack direction="row" minWidth={"100%"} minHeight={"70vh"} py={5} gap={2}>
      ...
      <Card sx={{ minWidth: "40%" }}>
        <div style={{position: "relative"}}>
          <img src={presentationImage} className={projectSectionStyles.teamImage} style={{top: "155px", right:"165px", width:"280px"}}/>
          <img src={workImage} className={projectSectionStyles.teamImage} style={{top: "10px", left:"10px", width:"200px"}}/>
          <img src={teamImage} className={projectSectionStyles.teamImage} style={{top: "340px", left:"50px", width:"300px"}}/>
