    ...
    useEffect(() => {
        if (data && d3Container.current) {
            ...
            const updateChart = (year: string) => {
                ...
                // Sort data
                yearData.sort((a, b) => b.total_local_passengers - a.total_local_passengers);

                x.domain(yearData.map(d => d.state));
                y.domain([0, d3.max(yearData, d => d.total_local_passengers) as number]);
                ...
                bars.enter().append("rect")
                    ...
                    .attr("y", d => y(d.total_local_passengers))
                    .attr("height", d => height - y(d.total_local_passengers))
